const latinVocab = {
    ...
    "absum": "be absent, be away, be distant from",
    "ac, atque": "and",
    "accido": "happen",
    ...
    "alter": "the other, another, one (of two), the second (of two)",
    "altus": "high, deep",
    "ambulo": "walk",
    "amicus": "friend",
    "amo": "love, like",
    ...
    "cado": "fall",
    "caelum": "sky, heaven",
    "capio": "take, catch, capture, make (a plan)",
...
function searchWord() {
    ...
    if (latinVocab[input]) {
        resultDiv.textContent = `Translation: ${latinVocab[input]}`;
    } else {
